...
int checkonline(lua_State* state) {
	...
	if (lua_isnumber(state, 1)) {
		...
		if (strcmpi(name, "") == 0) {
            ...
            strlwr(name_copy);
			if (SQL_ERROR == SqlStmt_Prepare(stmt, "Select `ChaId` FROM `Character` WHERE `ChaOnline` = '1' AND `ChaName` = '%s'", name_copy)
				|| SQL_ERROR == SqlStmt_Execute(stmt)) {
				SqlStmt_ShowDebug(stmt);
				SqlStmt_Free(stmt);
                free(name_copy);
...
int sl_getPoems(lua_State* state) {
	...
	for (i = 0, x = 1; i < SqlStmt_NumRows(stmt) && SQL_SUCCESS == SqlStmt_NextRow(stmt); i++, x += 3) {
		...
		lua_rawseti(state, -2, x + 1);
		lua_pushstring(state, (char *)topic); // poem topic
		lua_rawseti(state, -2, x + 2);
	}
...
int sl_setOfflinePlayerRegistry(lua_State* state) {
	unsigned int id = 0;
	const char* reg = lua_tostring(state, 2);
...
int sl_guitext(lua_State* state) {
	...
	if (type == -1 && m == 0) { // This check is so Server Broadcast (by passing -1 into first argument and 0 for mapid) will take priority over a game.
		for (i = 0; i < 65535; i++) {
			if (map_isloaded(i)) {
				map_foreachinarea(clif_guitext, i, 0, 0, SAMEMAP, BL_PC, string);
			}
		}
	}

	else { map_foreachinarea(clif_guitext, m, 0, 0, SAMEMAP, BL_PC, string); }
...
void sl_init() {
	...
	// make sure to load the sys.lua file befor e anything else!
...
int sl_doscript_stackargs(const char* root, const char* method, int nargs) {
...
int iteml_getattr(lua_State*, void*, char*);
...
int iteml_getattr(lua_State* state, void* self, char* attrname) {
	...
	else if (!strcmp(attrname, "rare")) lua_pushnumber(state, item->rare);
	...
	else if (!strcmp(attrname, "mark")) lua_pushnumber(state, item->mark);
...
int biteml_getattr(lua_State*, void*, char*);
int biteml_setattr(lua_State*, void*, char*);
void biteml_staticinit() {
...
int biteml_setattr(lua_State* state, void *self, char* attrname) {
...
int biteml_getattr(lua_State* state, void *self, char* attrname) {
    struct item* bitem = (struct item*)self;
...
int bankiteml_getattr(lua_State*, void*, char*);
int bankiteml_setattr(lua_State*, void*, char*);
void bankiteml_staticinit() {
...
int bankiteml_setattr(lua_State* state, void *self, char* attrname) {
...
int bankiteml_getattr(lua_State* state, void *self, char* attrname) {
    struct bank_data* bitem = (struct bank_data*)self;
...
int recipel_getattr(lua_State*, void*, char*);
...
int recipel_getattr(lua_State* state, void *self, char* attrname) {
...
int parcell_getattr(lua_State*, void*, char*);
void parcell_staticinit() {
	parcell_type = typel_new("Parcel", 0);
	parcell_type.getattr = parcell_getattr;
}
int parcell_getattr(lua_State* state, void *self, char* attrname) {
...
int regl_getattr(lua_State*, void*, char*);
int regl_setattr(lua_State*, void*, char*);
...
int regl_getattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
	lua_pushnumber(state, pc_readglobalreg(sd, attrname));
	return 1;
}
int regl_setattr(lua_State* state, void* self, char* attrname) {
    USER* sd = (USER*)self;
	pc_setglobalreg(sd, attrname, lua_tonumber(state, -1));
	return 1;
}

int reglstring_getattr(lua_State*, void*, char*);
int reglstring_setattr(lua_State*, void*, char*);
...
int reglstring_getattr(lua_State* state, void* self, char* attrname) {
    USER* sd = (USER*)self;
	lua_pushstring(state, pc_readglobalregstring(sd, attrname));
	return 1;
}
int reglstring_setattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
	pc_setglobalregstring(sd, attrname, lua_tostring(state, -1));
	return 1;
}

int npcintregl_getattr(lua_State*, void*, char*);
int npcintregl_setattr(lua_State*, void*, char*);
void npcintregl_staticinit() {
	npcintregl_type = typel_new("NpcInt", 0);
	npcintregl_type.getattr = npcintregl_getattr;
	npcintregl_type.setattr = npcintregl_setattr;
}
int npcintregl_getattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
    lua_pushnumber(state, pc_readnpcintreg(sd, attrname));
	return 1;
}
int npcintregl_setattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
	pc_setnpcintreg(sd, attrname, lua_tonumber(state, -1));
	return 1;
}
int questregl_getattr(lua_State*, void*, char*);
int questregl_setattr(lua_State*, void*, char*);
void questregl_staticinit() {
	questregl_type = typel_new("Quest", 0);
	questregl_type.getattr = questregl_getattr;
	questregl_type.setattr = questregl_setattr;
}
int questregl_getattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
	lua_pushnumber(state, pc_readquestreg(sd, attrname));
	return 1;
}
int questregl_setattr(lua_State* state, void *self, char* attrname) {
    USER* sd = (USER*)self;
...
int typel_mtindex(lua_State* state) {
	...
	if (type->getattr)
		result = type->getattr(state, inst->self, (char *)attrname);
	if (!result) {
...
int typel_mtnewindex(lua_State* state) {
	...
	int result = 0;
	if (type->setattr)
		result = type->setattr(state, inst->self, (char *)attrname);
...
int bll_permspawn(lua_State* state, void *self) {
    struct block_list *bl = (struct block_list *)self;
	return 0;
}
...
int fll_getattr(lua_State*, void*, char*);
int fll_setattr(lua_State*, void*, char*);
...
int fll_getattr(lua_State* state, void* self, char* attrname) {
    FLOORITEM* fl = (FLOORITEM*)self;
...
int fll_setattr(lua_State* state, void* self, char* attrname) {
    FLOORITEM* fl = (FLOORITEM*)self;
...
int npcl_getattr(lua_State*, void*, char*);
int npcl_setattr(lua_State*, void*, char*);
int npcregl_getattr(lua_State*, void*, char*);
int npcregl_setattr(lua_State*, void*, char*);
...
int npcl_getattr(lua_State* state, void* self, char* attrname) {
    NPC *nd = (NPC*)self;
...
int npcl_setattr(lua_State* state, void* self, char* attrname) {
    NPC *nd = (NPC*)self;
...
int npcregl_getattr(lua_State* state, void* self, char* attrname) {
    NPC *nd = (NPC*)self;
	lua_pushnumber(state, npc_readglobalreg(nd, attrname));
	return 1;
}

int npcregl_setattr(lua_State* state, void* self, char* attrname) {
    NPC *nd = (NPC*)self;
...
int mobl_getattr(lua_State*, void*, char*);
int mobl_setattr(lua_State*, void*, char*);
...
int mobregl_getattr(lua_State*, void*, char*);
int mobregl_setattr(lua_State*, void*, char*);
...
int mobl_getattr(lua_State* state, void* self, char* attrname) {
    MOB *mob = (MOB *)self;
...
int mobl_setattr(lua_State* state, void* self, char* attrname) {
    MOB *mob = (MOB *)self;
...
int mobl_sendstatus(lua_State* state, void* self) {
    MOB *mob = (MOB *)self;
    return 0;
}

int mobl_sendminitext(lua_State* state, void* self) {
    MOB *mob = (MOB *)self;
    return 0;
}

int mobregl_getattr(lua_State* state, void* self, char* attrname) {
    MOB *mob = (MOB *)self;
    lua_pushnumber(state, mob_readglobalreg(mob, attrname));
    return 0;
}

int mobregl_setattr(lua_State* state, void* self, char* attrname) {
    MOB *mob = (MOB *)self;
    mob_setglobalreg(mob, attrname, lua_tonumber(state, -1));
    return 0;
}
int pcl_inventory_popup(lua_State*, void*);
...
int pcl_getattr(lua_State*, void*, char*);
int pcl_setattr(lua_State*, void*, char*);
...
int pcl_addEventXP(lua_State*, void*); // add XP to player for specific event #
...
int pcl_checklevel(lua_State*, void*); //added for testing 11-26-16
...
void pcl_staticinit() {
	...
	typel_extendproto(&pcl_type, "inventoryPopup", pcl_inventory_popup);
...
int pcl_inventory_popup(lua_State* state, void* self) {
    USER *sd = (USER *)self;
    int slot = lua_tonumber(state, sl_memberarg(1));
    const char *body = lua_tostring(state, sl_memberarg(2));
    printf("Slot: %s \n", body);
    clif_inventory_popup(sd, slot, body);
    return 0;
}
...
int pcl_sendboardquestions(lua_State* state, void* self) {
    ...
    int amount = lua_objlen(state, sl_memberarg(1));
    ...
    while (lua_next(state, sl_memberarg(1)) != 0) {
        // key is at -2, value at -1
        int index = lua_tonumber(state, -2);
        strcpy((char *)&questions[index - 1].header, lua_tostring(state, -1));
        lua_pop(state, 1);
    }
    ...
    while (lua_next(state, sl_memberarg(2)) != 0) {
        // key is at -2, value at -1
        int index = lua_tonumber(state, -2);
        strcpy((char *)questions[index - 1].question, lua_tostring(state, -1));
        lua_pop(state, 1);
    }
...
int clandb_add(USER* sd, const char* name);
...
int pcl_setattr(lua_State* state, void* self, char* attrname) {
    USER *sd = (USER *)self;
...
int pcl_checkKan(lua_State* state, void* self)
{
    ...
    FREE(email);
    if (number != 0) { lua_pushnumber(state, number); return 1; }
...
int pcl_getattr(lua_State* state, void* self, char* attrname) {
    USER *sd = (USER *)self;
...
int pcl_addinventoryitem(lua_State* state, void* self) {
    USER *sd = (USER *)self;
    return 1;
}
...
int pcl_removeinventoryitem(lua_State* state, void* self) {
    ...
    tmp_engrave = lua_tostring(state, sl_memberarg(5));
    max = amount;

    CALLOC(engrave, char, 64);

    if (tmp_engrave != NULL) {
        strcpy(engrave, tmp_engrave);
    }
...
int pcl_hasitem(lua_State* state, void* self) {
    ...
    amount = fabs(lua_tonumber(state, sl_memberarg(2)));
    dura = lua_tonumber(state, sl_memberarg(3));
    owner = lua_tonumber(state, sl_memberarg(4));
    tmp_engrave = lua_tostring(state, sl_memberarg(5));
    ...
    tmp_note = lua_tostring(state, sl_memberarg(10));
...
int pcl_hasspace(lua_State* state, void* self) {
    ...
    tmp_engrave = lua_tostring(state, sl_memberarg(4));
...
int pcl_removeparcel(lua_State* state, void* self) {
    ...
    int owner = lua_tonumber(state, sl_memberarg(5));
    const char* engrave = lua_tostring(state, sl_memberarg(6));
    const char npcflag = lua_tonumber(state, sl_memberarg(7));
...
int pcl_getallspells(lua_State* state, void* self) {
    USER *sd = (USER *)self; // Used to display all spells in game
    int i, j, x;
    unsigned int id;
    unsigned int idlist[255];
    char found = 0;
...
int pcl_testpacket(lua_State* state, void* self) {
    ...
    while (lua_next(state, sl_memberarg(1)) != 0) {
        ...
        if (lua_isnumber(state, -1)) {
            ...
            strcpy((char *)WFIFOP(sd->fd, i - 1 + index), lua_tostring(state, -1));
...
int mapregl_getattr(lua_State*, void*, char*);
int mapregl_setattr(lua_State*, void*, char*);
...
int mapregl_setattr(lua_State* state, void *self, char* attrname) {
    USER *sd = (USER *)self;
	map_setglobalreg(sd->bl.m, attrname, lua_tonumber(state, -1));
	return 0;
}

int mapregl_getattr(lua_State* state, void *self, char* attrname) {
    USER *sd = (USER *)self;
...
//game registries
int gameregl_setattr(lua_State* state, void *self, char* attrname) {
	map_setglobalgamereg(attrname, lua_tonumber(state, -1));

	return 0;
}

int gameregl_getattr(lua_State* state, void *self, char* attrname) {
