...
struct item_data {
	...
	int rare, mark, price, sell, rank, stack_amount, look, look_color, dura, might, will, grace, ac, dam, hit, vita, mana, protection, protected, healing, wisdom, con, attack_speed, icon;
