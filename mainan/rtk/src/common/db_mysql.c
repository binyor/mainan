...
///
/// @private
static int Sql_P_KeepaliveTimer(uintptr_t data, int none)
{
	Sql* self = (Sql*)data;
...
///
/// @private
static int Sql_P_BindSqlDataType(MYSQL_BIND* bind, enum SqlDataType buffer_type, void* buffer, size_t buffer_len, unsigned long* out_length, int8_t* out_is_null)
{
...
int SqlStmt_BindColumn(SqlStmt* self, size_t idx, enum SqlDataType buffer_type, void* buffer, size_t buffer_len, uint32* out_length, int8_t* out_is_null)
{
	if (self == NULL)
		return SQL_ERROR;
