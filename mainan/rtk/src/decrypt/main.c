...
/*
 ...
 svkey1packets are all packet types sent out from server that must tk_encrypt using
 key1.
...
unsigned char refpacket[] = {0xAA, 0x00, 0x56, 0x59, 0x03, 0x4D, 0x6C, 0x7B, 0x3C, 0x3A, 0x25, 0x02, 0x04, 0x48, 0x22, 0x47, 0x09, 0x0C, 0x0E, 0x2E, 0x1E, 0x68, 0x68, 0x3A, 0x16, 0x18, 0x0C, 0x06, 0x24, 0x06, 0x16, 0x56, 0x77, 0x46, 0x4A, 0x5C, 0x5D, 0x7A, 0x42, 0x51, 0x1D, 0x79, 0x52, 0x5F, 0x40, 0x58, 0x7E, 0x59, 0x41, 0x00, 0x41, 0x27, 0x2E, 0x3A, 0x52, 0x6F, 0x48, 0x45, 0x08, 0x6B, 0x40, 0x5D, 0x5D, 0x62, 0x45, 0x62, 0x27, 0x45, 0x33, 0x41, 0x3F, 0x07, 0x0B, 0x3E, 0x19, 0x47, 0x0A, 0x65, 0x22, 0x16, 0x12, 0x00, 0x2E, 0x45, 0x59, 0x05, 0x16, 0x0A, 0x03 };
...
char* generate_hashvalues(const char* name, char* outbuffer, int buflen)
{
	...
	cvs_MD5Init(&context);
	cvs_MD5Update(&context, (unsigned char *)name, strlen((char *)name));
