jewelrymaking = {
	...
	bracelet = function(player, skill)
		local choices = {}
		local item = ""

		if player:hasItem("crafted_amber", 6) == true or player:hasItem("well_crafted_amber", 2) == true then
			table.insert(choices, "Amber")
		end
		if player:hasItem("crafted_dark_amber", 6) == true or player:hasItem("well_crafted_dark_amber", 2) == true then
			table.insert(choices, "Dark amber")
		end
		if player:hasItem("crafted_white_amber", 6) == true or player:hasItem("well_crafted_white_amber", 2) == true then
			table.insert(choices, "White amber")
		end
		if player:hasItem("crafted_yellow_amber", 6) == true or player:hasItem("well_crafted_yellow_amber", 2) == true then
			table.insert(choices, "Yellow amber")
		end
		...
		if choices[choice] == "Amber" then
			...
			if player:hasItem("crafted_amber", 6) == true then
				player:removeItem("crafted_amber", 6)
				item = "crafted_amber"
			elseif player:hasItem("well_crafted_amber", 6) == true then
				player:removeItem("well_crafted_amber", 6)
				item = "well_crafted_amber"
			end
			...
			if item == "crafted_amber" then
				if (rand <= 1 * skill) then
					player:addItem("luxury_amber_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("luxury_amber_bracelet").icon,
								color = Item("luxury_amber_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
				...
				elseif (rand <= 3 * skill) then
					player:addItem("plain_amber_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("plain_amber_bracelet").icon,
								color = Item("plain_amber_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
			...
			elseif item == "well_crafted_amber" then
				if (rand <= 2 * skill) then
					player:addItem("luxury_amber_bracelet", 1)
					player:dialogSeq(
						{
		...
		if choices[choice] == "Dark amber" then
			...
			if player:hasItem("crafted_dark_amber", 6) == true then
				player:removeItem("crafted_dark_amber", 6)
				item = "crafted_dark_amber"
			elseif player:hasItem("well_crafted_dark_amber", 6) == true then
				player:removeItem("well_crafted_dark_amber", 6)
				item = "well_crafted_dark_amber"
			end
			...
			if item == "crafted_dark_amber" then
				if (rand <= 1 * skill) then
					player:addItem("plain_dark_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("plain_dark_bracelet").icon,
								color = Item("plain_dark_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
				...
				elseif (rand <= 3 * skill) then
					player:addItem("luxury_dark_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("luxury_dark_bracelet").icon,
								color = Item("luxury_dark_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
			...
			elseif item == "well_crafted_dark_amber" then
				if (rand <= 2 * skill) then
					player:addItem("plain_dark_bracelet", 1)
					player:dialogSeq(
						{
		...
		if choices[choice] == "White amber" then
			...
			if player:hasItem("crafted_white_amber", 6) == true then
				player:removeItem("crafted_white_amber", 6)
				item = "crafted_white_amber"
			elseif player:hasItem("well_crafted_white_amber", 6) == true then
				player:removeItem("well_crafted_white_amber", 6)
				item = "well_crafted_white_amber"
			end
			...
			if item == "crafted_white_amber" then
				if (rand <= 1 * skill) then
					player:addItem("luxury_white_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("luxury_white_bracelet").icon,
								color = Item("luxury_white_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
				...
				elseif (rand <= 3 * skill) then
					player:addItem("plain_white_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("plain_white_bracelet").icon,
								color = Item("plain_white_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
			...
			elseif item == "well_crafted_white_amber" then
				if (rand <= 2 * skill) then
					player:addItem("luxury_white_bracelet", 1)
					player:dialogSeq(
						{
		...
		if choices[choice] == "Yellow amber" then
			...
			if player:hasItem("crafted_yellow_amber", 6) == true then
				player:removeItem("crafted_yellow_amber", 6)
				item = "crafted_yellow_amber"
			elseif player:hasItem("well_crafted_yellow_amber", 6) == true then
				player:removeItem("well_crafted_yellow_amber", 6)
				item = "well_crafted_yellow_amber"
			end
			...
			if item == "crafted_yellow_amber" then
				if (rand <= 1 * skill) then
					player:addItem("luxury_yellow_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("luxury_yellow_bracelet").icon,
								color = Item("luxury_yellow_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
				...
				elseif (rand <= 3 * skill) then
					player:addItem("plain_yellow_bracelet", 1)
					player:dialogSeq(
						{
							{
								graphic = Item("plain_yellow_bracelet").icon,
								color = Item("plain_yellow_bracelet").iconC
							},
							"Your efforts were successful!"
						},
						0
			...
			elseif item == "well_crafted_yellow_amber" then
				if (rand <= 2 * skill) then
					player:addItem("luxury_yellow_bracelet", 1)
					player:dialogSeq(
						{
