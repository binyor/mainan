...
local _defaultWaypoints = "|kugnae|buya|nagnang|mythic_nexus|blank_kingdom|"
...
local _waypoints = {
    ...
    },
	{
		...
		keywords = {"buya"},
        includeOnMaps = {1122, 1031, 522, 753},
		excludeOnMap = -1,
        excludeInRegion = 1,
		costFactor = 1,
        map = 330,
	...
	},
	{
		id = "blank_kingdom",
		label = "Blank Kingdom",
        description = "Blank Kingdom is a fresh start",
		keywords = {"blank"},
        includeOnMaps = {},
		excludeOnMap = 753,
        excludeInRegion = -1,
...
--	local choice = player:menuString(""..waypoint.description.."\n\nThe fare is "..Tools.formatNumber(fare).." coins.\nDo you wish to travel there?",{"Yes!", "No"})
