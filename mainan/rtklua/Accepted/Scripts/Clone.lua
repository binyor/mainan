clone = {
	...
	equipNPC = function(player, npc)
		local weap = {look = npc.gfxWeap, lookC = npc.gfxWeapC}
		local coat = {look = npc.gfxArmor, lookC = npc.gfxArmorC}
		local armor = {look = npc.gfxArmor, lookC = npc.gfxArmorC}
		local helm = {look = npc.gfxHelm, lookC = npc.gfxHelmC}
		local crown = {look = npc.gfxCrown, lookC = npc.gfxCrownC}
		local mantle = {look = npc.gfxMantle, lookC = npc.gfxMantleC}
		local shield = {look = npc.gfxShield, lookC = npc.gfxShieldC}
		local boots = {look = npc.gfxBoots, lookC = npc.gfxBootsC}
		local facea = {look = npc.gfxFaceA, lookC = npc.gfxFaceAC}
		local neck = {look = npc.gfxNeck, lookC = npc.gfxNeckC}
