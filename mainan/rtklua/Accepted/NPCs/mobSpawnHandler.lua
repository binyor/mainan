...
MobSpawnHandlerNpc = {
	action = function(npc)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 752, {2}, {25}, 300, 12, 44, 96, 52)
		MobSpawnHandlerNpc.handleSpawn(npc, 752, {3}, {7}, 300, 12, 44, 96, 52)
		MobSpawnHandlerNpc.handleSpawn(npc, 752, {11}, {3}, 300, 90, 41, 95, 44)
		MobSpawnHandlerNpc.handleSpawn(npc, 752, {822}, {1}, 300, 75, 45, 75, 45)
		...
		--TIER 1
		MobSpawnHandlerNpc.handleSpawn(npc, 8400, {831,832}, {40,30}, 300, 12, 0, 64, 69)
		MobSpawnHandlerNpc.handleSpawn(npc, 8400, {837}, {1}, 2700, 0, 9, 84, 53)
		MobSpawnHandlerNpc.handleSpawn(npc, 8400, {838}, {1}, 900, 0, 9, 84, 53)

		MobSpawnHandlerNpc.handleSpawn(npc, 8403, {839}, {25}, 300, 1, 3, 28, 26)

		--TIER 2
		MobSpawnHandlerNpc.handleSpawn(npc, 8412, {833,834}, {30,40}, 300, 12, 0, 64, 69)
		MobSpawnHandlerNpc.handleSpawn(npc, 8412, {842}, {1}, 2700, 0, 9, 84, 53)
		MobSpawnHandlerNpc.handleSpawn(npc, 8412, {838}, {1}, 900, 0, 9, 84, 53)

		MobSpawnHandlerNpc.handleSpawn(npc, 8415, {840}, {25}, 300, 1, 3, 28, 26)

		--TIER 3
		MobSpawnHandlerNpc.handleSpawn(npc, 8424, {835,836}, {40,30}, 300, 12, 0, 64, 69)
		MobSpawnHandlerNpc.handleSpawn(npc, 8424, {838}, {1}, 900, 0, 9, 84, 53)
		MobSpawnHandlerNpc.handleSpawn(npc, 8424, {843}, {1}, 2700, 0, 9, 84, 53)

		MobSpawnHandlerNpc.handleSpawn(npc, 8427, {841}, {25}, 300, 1, 3, 28, 26)

		--TIER 2.5

		MobSpawnHandlerNpc.handleSpawn(npc, 8450, {845,846}, {40,30}, 300, 12, 0, 64, 69)
		MobSpawnHandlerNpc.handleSpawn(npc, 8450, {848}, {1}, 2700, 0, 9, 84, 53)
		MobSpawnHandlerNpc.handleSpawn(npc, 8450, {838}, {1}, 900, 0, 9, 84, 53)

		MobSpawnHandlerNpc.handleSpawn(npc, 8453, {847}, {25}, 300, 1, 3, 28, 26)
		...
		--MobSpawnHandlerNpc.handleSpawn(npc, 32103, {810}, {600}, 300, 1, 1, 124, 124)
		
		-- Wilderness
		MobSpawnHandlerNpc.handleSpawn(
			npc,
			1002,
			{1, 2, 3, 4, 10, 70, 8, 9, 72, 73, 74, 599},
...
--	                             					handleSpawn = function(npc, map, mobs, maxMobs, timer, spawnMinX, spawnMinY, spawnMaxX, spawnMaxY)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 5331, {815, 816, 817}, {40, 40, 60}, 300, 15, 8, 70, 94)
		MobSpawnHandlerNpc.handleSpawn(npc, 5331, {818}, {5}, 1200, 15, 8, 70, 94)
		MobSpawnHandlerNpc.handleSpawn(npc, 5331, {819}, {1}, 3600, 15, 8, 70, 94)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 73, {693}, {2}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 79, {693}, {2}, 300)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4164, {334, 335}, {15, 15}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 4165, {334, 335}, {15, 15}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 4166, {334, 335}, {15, 15}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 4167, {335, 336}, {20, 10}, 300)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 3176, {367, 368}, {20, 40}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 3177, {367, 368}, {13, 13}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 3178, {367, 368}, {13, 20}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 3179, {367, 368}, {20, 20}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 3180, {369}, {35}, spawnRates["ox_sentry"][2])
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4176, {373, 374}, {20, 40}, 300)
		...
		-- Pig 2
		MobSpawnHandlerNpc.handleSpawn(npc, 3181, {352}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 3182, {353, 354}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 3183, {356}, {20}, spawnRates["pig_sentry"][2])
		MobSpawnHandlerNpc.handleSpawn(npc, 3184, {352, 353}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(
			npc,
			3185,
			{352, 353, 354},
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 3186, {354}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 3187, {354, 355}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 3188, {354}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc,3189,{353, 354, 355},{10, 10, 10},180)
		MobSpawnHandlerNpc.handleSpawn(npc, 3190, {354}, {30}, 180)

		-- Pig 3
		MobSpawnHandlerNpc.handleSpawn(npc, 4181, {359}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 4182, {360, 361}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 4183, {363}, {20}, spawnRates["pig_sentry"][3])
		MobSpawnHandlerNpc.handleSpawn(npc, 4184, {359, 360}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(
			npc,
			4185,
			{359, 360, 361},
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4186, {361}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 4187, {361, 362}, {15, 15}, 180)
		MobSpawnHandlerNpc.handleSpawn(npc, 4188, {361}, {30}, 180)
		MobSpawnHandlerNpc.handleSpawn(
			npc,
			4189,
			{360, 361, 362},
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4190, {361}, {30}, 180)
		...
		-- Horse 1
		MobSpawnHandlerNpc.handleSpawn(npc, 240, {38, 39, 138}, {10, 10, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 241, {38, 138}, {20, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 242, {39, 40, 138}, {10, 10, 10}, 210)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 245, {39, 138}, {20, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 246, {38}, {20}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 247, {39, 40, 41}, {20, 20, 20}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 248, {41, 40, 39}, {12, 12, 15}, 210)

		-- Horse 2
		MobSpawnHandlerNpc.handleSpawn(npc, 3240, {378, 380, 382}, {10, 10, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3241, {378, 379}, {15, 15}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3242, {380, 378, 382}, {10, 10, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3243, {380, 381, 382}, {15, 15, 5}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3244, {382, 379}, {20, 40}, spawnRates["horse_sentry"][2])
		MobSpawnHandlerNpc.handleSpawn(npc, 3245, {380, 382}, {20, 7}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3246, {378}, {20}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3247, {380, 381, 379, 382}, {13, 13, 13, 8}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3248, {381, 379, 380}, {12, 12, 15}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 3248, {382}, {3}, 300)

		-- Horse 3
		MobSpawnHandlerNpc.handleSpawn(npc, 4240, {385, 386, 389}, {10, 10, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4241, {385, 389}, {15, 15}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4242, {386, 385, 389}, {10, 10, 10}, 210)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4245, {386, 389}, {20, 10}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4246, {385}, {20}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4247, {386, 387, 388, 389}, {13, 13, 13, 8}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4248, {388, 387, 386}, {12, 12, 15}, 210)
		MobSpawnHandlerNpc.handleSpawn(npc, 4248, {389}, {3}, 300)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 3254, {418}, {25}, 150)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4254, {424}, {25}, 150)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 474, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 475, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 476, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 477, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 478, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 479, {106}, {20}, spawnRates["sheep_sentry"][1])
		MobSpawnHandlerNpc.handleSpawn(npc, 480, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 481, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 482, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 483, {46, 47}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 484, {46, 47}, {15, 15}, 100)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 3474, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3475, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3476, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3477, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3478, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3479, {394}, {20}, spawnRates["sheep_sentry"][2])
		MobSpawnHandlerNpc.handleSpawn(npc, 3480, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3481, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3482, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3483, {392, 393}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 3484, {392, 393}, {15, 15}, 100)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 4474, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4475, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4476, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4477, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4478, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4479, {399}, {20}, spawnRates["sheep_sentry"][3])
		MobSpawnHandlerNpc.handleSpawn(npc, 4480, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4481, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4482, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4483, {397, 398}, {15, 15}, 100)
		MobSpawnHandlerNpc.handleSpawn(npc, 4484, {397, 398}, {15, 15}, 100)
		...
		MobSpawnHandlerNpc.handleSpawn(npc, 1005, {511}, {15}, 300, 100, 5, 247, 38)
		...
		-- Buya Fox 	handleSpawn = function(npc, map, mobs, maxMobs, timer, spawnMinX, spawnMinY, spawnMaxX, spawnMaxY)

		MobSpawnHandlerNpc.handleSpawn(npc, 390, {75}, {20}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 390, {75}, {20}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 391, {75}, {20}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 392, {693}, {1}, 300)
		MobSpawnHandlerNpc.handleSpawn(npc, 393, {693}, {1}, 300)
		MobSpawnHandlerNpc.handleSpawn(
			npc,
			393,
			{75, 76, 77, 78},
