BladestormTrapNpc = {
	...
	click = function(block, npc)
		...
		if block.blType == BL_MOB then
			if block.yname == "xmas_yeti" or block.yname == "xmas_deer" or block.yname == "xmas_yeti2" or block.yname == "xmas_yeti4" or block.yname == "xmas_yeti3" then
				block:talk(0,"Merry Christmas!")
				removeTrapItem(npc)
				npc:delete()				
				return
			end
