	...
	click = async(function(player, npc)
		...
		elseif choice == "Bon-Hwa Immortality" then
			...
			if choice2 == "My Weapon" then
				...
				if choice3 == 1 then
					...
					if (player:hasItem(selected_item.yname, selected_item.amount) == true) then
						...
						player:dialogSeq({t, "Do you think you're slick? Try again."},0)
						return
					end
		...
		elseif choice == "Ee San" then
			...
			elseif choice2 == "Second Trial of Skill" then
				...
				if player.registry["carnageWin"] + player.registry["bloodlustWin"] + player.registry["elixir_war_victories"] + player.registry[
					"bomber_war_wins"
