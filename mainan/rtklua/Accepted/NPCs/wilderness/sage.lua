SageNpc = {
	click = async(function(player, npc)
		...
		-- 2 weeks, 4 weeks, 6 weeks, 8 weeks, reset back to 0  MICDOG 172800 FOR 2 DAYS
		...
		"Sharing of wisdom not needed to the world of Three Kingdoms can result in loss of this spell.",
		...
		"Breaking any other law in Three Kingdoms using this spell will result in loss of the spell."},1)]]
		--
		...
		player:dialogSeq(
			{
				...
				"Jailing for ANY crime will result in loss of this spell.",
				"Breaking any other law in Three Kingdoms using this spell will result in loss of the spell."
			},
			1
		)
