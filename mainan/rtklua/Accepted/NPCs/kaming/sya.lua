SyaNpc = {
	click = async(function(player, npc)
		...
		if player.registry["bardq"] == 15 then
			player.registry["bardq"] = 16
			player:dialogSeq({t,"Hello, Oh yes a feast, I'll gladly come!","But please could you let everyone else know too?","It's not really a feast without those you care for!"},0)
			end

		if player.registry["bardq"] == 16 then
			player:dialogSeq({t,"Hello, Oh yes a feast, I'll gladly come!","But please could you let everyone else know too?","It's not really a feast without those you care for!"},0)
			end

		if player.registry["bardq"] == 18 then
			player.registry["bardq"] = 19
			player:dialogSeq({t,"Thank you for allowing everyone to come! We'll see you soon!"},0)
		end
