TownCrierNpc = {
	click = async(function(player, npc)
		...
		if npc.mapTitle == "Blank Kingdom" then
			table.insert(opts, "Move to Blank Kingdom")
			table.insert(opts, "Blank Kingdom Defender")
		end
		...
		if choice == "Move to Koguryo" or choice == "Move to Buya" or choice == "Move to Nagnang" or choice == "Move to Blank Kingdom" then
			local country = 0
			...
			elseif npc.mapTitle == "Nagnang" then
				country = 3
			elseif npc.mapTitle == "Blank Kingdom" then
				country = 4
			end
