...
SmithNpc = {
	click = async(function(player, npc)
		...
		if npc.mapTitle == "Beard Smith" or npc.mapTitle == "Dok Smith" or npc.mapTitle == "Blank Kingdom" then
	...
	buyItems = function(npc)
		...
		if npc.mapTitle == "Thane's Cave" or npc.mapTitle == "Blank Kingdom" then
