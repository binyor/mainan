...
WarriorTrainerNpc = {
	click = async(function(player, npc)
		...
		elseif choice == "Divine Secret" then
			if npc.mapTitle == "Sword" or npc.mapTitle == "Kwi-Sin Sword" or npc.mapTitle == "Ming-Ken Sword" or npc.mapTitle == "Ohaeng Sword" or npc.mapTitle == "Ohaeng Sanctum" or npc.mapTitle == "Kwi-Sin Sanctum" or npc.mapTitle == "Ming-Ken Sanctum" then
