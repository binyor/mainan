...
-- Cartel Clan Door
	if (player.m == 5066 or player.m == 775) then
		if player:hasItem(player.clanName .."_clan_key", 1) == true then
			if (obj == 17150) then
				for i = 0, 2 do
					setObject(m, x + i, y, 17157 + i)
				end
			elseif (obj == 17151) then
				for i = 0, 2 do
					setObject(m, x - 1 + i, y, 17157 + i)
				end
			elseif (obj == 17152) then
				for i = 0, 2 do
					setObject(m, x - 2 + i, y, 17157 + i)
				end
			elseif (obj == 17157) then
				for i = 0, 2 do
					setObject(m, x + i, y, 17150 + i)
				end
			elseif (obj == 17158) then
				for i = 0, 2 do
					setObject(m, x - 1 + i, y, 17150 + i)
				end
			elseif (obj == 17159) then
				for i = 0, 2 do
					setObject(m, x - 2 + i, y, 17150 + i)
				end
			end
		else
			player:sendMinitext("The door is locked.")
