heroic_stance = {
	cast = function(player)
		...
		if (player:hasDuration("heroic_stance") == true and player.rage == 8) then
			-- cast rage2
			...
			player:sendAnimation(491)
			player:playSound(705)
			player:sendMinitext("[Stance 2] You tighten your grip and enhance your power.")
			player:sendAction(6, 35)
			player.registry["chungryongragelevel"] = 2
			player:setAether("heroic_stance", aethers)

			player:calcStat()
		elseif (player:hasDuration("heroic_stance") == true and player.rage == 14) then
			-- cast rage3
			...
			player:sendAnimation(491)
			player:playSound(705)
			player:sendMinitext("[Stance 3] Your immovable stance is growing in power.")
			...
			player:calcStat()
		elseif (player:hasDuration("heroic_stance") == true and player.rage == 20) then
			-- cast rage4
			...
			player:sendAnimation(491)
			player:playSound(705)
			player:sendMinitext("[Stance 4] You overwhelm your enemies with your hardened stance.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("heroic_stance") == true and player.rage == 26) then
			-- cast rage5
			...
			player:sendAnimation(491)
			player:playSound(705)
			player:sendMinitext("[Stance 5] Your wounds ache, but you hold your stance.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("heroic_stance") == true and player.rage == 36) then
			-- cast rage6
			...
			player:sendAnimation(491)
			player:playSound(705)
			player:sendMinitext("[Stance 6] You are unstoppable, nobody can break your stance.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("heroic_stance") == false) then
			...
			player:setDuration("heroic_stance", duration)
			player:setAether("heroic_stance", aethers)
			player:sendMinitext("[Stance 1] You stand tall to protect your allies.")
			player:sendAction(6, 35)
			player:calcStat()
		end
	end,
...
--			player.armor = player.armor - 50
	...
	requirements = function(player)
		...
		local description = "Increase your strength through phases while retaining your defense."
