breathing_technique = {
	cast = function(player)
		...
		if (player:hasDuration("breathing_technique") == true and player.rage == 8) then
			-- cast rage2
			...
			player:sendAnimation(125)
			player:playSound(705)
			player:sendMinitext("You take a deep breath, invoking the power of air.")
			player:sendAction(6, 35)
			player.registry["chungryongragelevel"] = 2
			player:setAether("breathing_technique", aethers)

			player:calcStat()
		elseif (player:hasDuration("breathing_technique") == true and player.rage == 14) then
			-- cast rage3
			...
			player:sendAnimation(125)
			player:playSound(705)
			player:sendMinitext("You take a deep breath, invoking the power of earth.")
			...
			player:calcStat()
		elseif (player:hasDuration("breathing_technique") == true and player.rage == 20) then
			-- cast rage4
			...
			player:sendAnimation(125)
			player:playSound(705)
			player:sendMinitext("You take a deep breath, invoking the power of fire.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("breathing_technique") == true and player.rage == 26) then
			-- cast rage5
			...
			player:sendAnimation(125)
			player:playSound(705)
			player:sendMinitext("You take a deep breath, invoking the power of lightning.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("breathing_technique") == true and player.rage == 36) then
			-- cast rage6
			...
			player:sendAnimation(125)
			player:playSound(705)
			player:sendMinitext("You take a deep breath, invoking the power of the sun.")
			player:sendAction(6, 35)
			...
			player:calcStat()
		elseif (player:hasDuration("breathing_technique") == false) then
			...
			player:setDuration("breathing_technique", duration)
			player:setAether("breathing_technique", aethers)
			player:sendMinitext("You take a deep breath, invoking the power of water.")
			player:sendAction(6, 35)
			player:calcStat()
		end
	end,
	...
	requirements = function(player)
		...
		local description = "Enhance your strength with your elemental breathing."
