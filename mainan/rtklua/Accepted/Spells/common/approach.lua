approach_spell = {
	cast = function(player, question)
		...
		--local choice = player:input("Mau mendekati siapa?")
		...
		if player.warpOut == 0 then
			player:sendMinitext("Itu tidak berfungsi di sini.")
			return
		end
	...
	requirements = function(player)
		...
		local desc = "Mantra ini digunakan untuk mendekati anggota grup."
