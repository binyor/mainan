onScriptedTilesMap = function(player)
	...
	if mapTitle == "Nagnang Gathering" then
		if ((y == 12 or y == 13 or y == 14 or y == 15) and x == 17) then
			sendWorldMap2(player, "Nagnang")
		end
	end
	...
	if mapTitle == "Blank Kingdom" then
		if (x == 0 and (y == 82 or y == 81)) then
			sendWorldMap(player, "Blank Kingdom")
		end
	end
end
