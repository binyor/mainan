onScriptedTilesPathHalls = function(player)
	...
	--------- BLANK PATH HALLS -----------------------
	if mapName == "Warrior Sanctum" then
		if ((x == 8 or x == 9) and y == 1) then
			if player.alignment == 0 then
				player:warp(755, x - 3, 18)
			elseif player.alignment == 1 then
				player:warp(756, x - 3, 18)

				-- kwi-sin
			elseif player.alignment == 2 then
				player:warp(757, x - 3, 18)

				-- ming-ken
			elseif player.alignment == 3 then
				player:warp(758, x - 3, 18)
	...
	if mapName == "Mage Sanctum" then
		if ((x == 8 or x == 9) and y == 1) then
			if player.alignment == 0 then
				player:warp(760, x - 3, 18)
			elseif player.alignment == 1 then
				player:warp(761, x - 3, 18)

				-- kwi-sin
			elseif player.alignment == 2 then
				player:warp(762, x - 3, 18)

				-- ming-ken
			elseif player.alignment == 3 then
				player:warp(763, x - 3, 18)
	...
	if mapName == "Rogue Headquarters" then
		if ((x == 8 or x == 9) and y == 1) then
			if player.alignment == 0 then
				player:warp(765, x - 3, 18)
			elseif player.alignment == 1 then
				player:warp(766, x - 3, 18)

				-- kwi-sin
			elseif player.alignment == 2 then
				player:warp(767, x - 3, 18)

				-- ming-ken
			elseif player.alignment == 3 then
				player:warp(768, x - 3, 18)
	...
	if mapName == "Poet Grand Hall" then
		if ((x == 8 or x == 9) and y == 1) then
			if player.alignment == 0 then
				player:warp(770, x - 3, 18)
			elseif player.alignment == 1 then
				player:warp(771, x - 3, 18)

				-- kwi-sin
			elseif player.alignment == 2 then
				player:warp(772, x - 3, 18)

				-- ming-ken
			elseif player.alignment == 3 then
				player:warp(773, x - 3, 18)
