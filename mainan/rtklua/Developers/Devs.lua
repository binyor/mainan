function Player.staff(player, str, int)
	local loreTable = {charIDs = {3, 105, 20,722,755}, charLevels = {5,5, 5, 5, 5}}
	local mapTable = {charIDs = {3, 105, 20,722,755}, charLevels = {5,5, 5, 5, 5}}
	local scriptTable = {charIDs = {3, 105, 20,722,755}, charLevels = {5,5, 5, 5, 5}}
	local projectManagerTable = {charIDs = {3, 105, 20,722,755}, charLevels = {5,5, 5, 5, 5}}
	local accessLevel = false
