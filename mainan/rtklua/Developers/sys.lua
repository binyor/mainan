...
advice = {
	"First time in Three Kingdoms? Visit www.ThreeKingdoms.com or check out the boards",
	...
	"Subpaths are chosen at level 70 by visiting the leader of your subpath choice.",
